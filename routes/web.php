...
Route::middleware(['handle.inertia'])->group(function () {
    ...
    Route::group(['middleware' => 'check.auth'], function () {
        ...
        Route::post('/plans/{plan}/complete', [PlanController::class, 'markComplete'])->name('plans.complete');
        Route::post('/plans/{plan}/toggle-status', [PlanController::class, 'toggleCompletion'])->name('plans.toggle');
